...
const defaultProps = {
  answer: {wasCorrect: true, correctGame: {id: 1, name: "DummyGame", cover: "http://example.org/image.png"}},
...
describe('<GameAnswer />', () => {
  ...
  it('should display IncorrectAnswer if the answer was incorrect.', () => {
    wrapper.setProps({answer: {wasCorrect: false, correctGame: {id: 1, name: "DummyGame", cover: "http://example.org/image.png"}}});
  ...
  it('should pass the correct game into IncorrectAnswer.', () => {
    const props = {answer: {wasCorrect: false, correctGame: {id: 1, name: "DummyGame", cover: "http://example.org/image.png"}}};
    wrapper.setProps(props);
    expect(wrapper.find(IncorrectAnswer).props()).toEqual({game: props.answer.correctGame});
  });
